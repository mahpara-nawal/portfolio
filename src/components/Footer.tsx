export default function Footer() {
  return (
    <footer className="py-12 px-4 sm:px-8">
      <div className="max-w-[1300px] mx-auto glass p-4 sm:p-6 md:p-10 rounded-3xl">

        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
          <div className="text-center md:text-left">
            <div className="text-sm font-semibold text-white/70" style={{ fontFamily: "'ASTONIX', 'Orbitron', 'Audiowide', sans-serif" }}>Mahpara Nawal</div>
            <div className="text-[10px] font-mono mt-1 tracking-wider" style={{ color: "var(--text-muted)" }}>&copy; {new Date().getFullYear()}</div>
          </div>
          <div className="flex items-center gap-5" style={{ color: "var(--text-muted)" }}>
            <a href="mailto:mahpara.fariba@gmail.com" className="hover:text-[var(--accent)] transition-colors">
            ...
            <a href="https://www.linkedin.com/in/mahpara-nawal-b96964239" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] transition-colors">
            ...
            <a href="https://github.com/mahpara-nawal" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
            </a>
          </div>
          <div className="hidden sm:flex gap-5 text-[10px] tracking-wider uppercase font-mono" style={{ color: "var(--text-muted)" }}>
