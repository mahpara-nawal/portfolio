export default function Footer() {
  return (
    <footer className="py-12 px-8">
      <div className="max-w-[1300px] mx-auto glass p-8 md:p-10 rounded-3xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-5 text-[10px] tracking-wider uppercase font-mono" style={{ color: "var(--text-muted)" }}>
